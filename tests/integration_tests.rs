...
mod integration_tests {
    ...
    mod compilation_integration_tests {
        ...
        fn test_full_project_build() {
            ...
            assert!(Path::new("target/debug/iora").exists(),
        ...
        fn test_release_build() {
            ...
            assert!(Path::new("target/release/iora").exists(),
        ...
        fn test_dependencies_resolve_correctly() {
            ...
            for dep in core_deps {
                assert!(tree_output.contains(dep),
                    "Dependency '{}' should be resolved in cargo tree", dep);
            }
        }
    ...
    mod module_integration_tests {
        ...
        fn test_rag_module_structure() {
            ...
            // Check for basic struct and functionality
            assert!(rag_content.contains("pub struct RagSystem"),
                "RAG module should have RagSystem struct");
            assert!(rag_content.contains("impl RagSystem"),
        ...
        fn test_analyzer_module_structure() {
            ...
            // Check for basic struct and functionality
            assert!(analyzer_content.contains("pub struct Analyzer"),
                "Analyzer module should have Analyzer struct");
            assert!(analyzer_content.contains("impl Analyzer"),
        ...
        fn test_solana_module_structure() {
            ...
            // Check for basic struct and functionality
            assert!(solana_content.contains("pub struct SolanaOracle"),
                "Solana module should have SolanaOracle struct");
            assert!(solana_content.contains("impl SolanaOracle"),
        ...
        fn test_library_exposes_all_modules() {
            ...
            for module in required_modules {
                assert!(lib_content.contains(&format!("pub mod {};", module)),
                    "Library should publicly export module '{}'", module);
            }
        }
    }
    ...
    mod asset_integration_tests {
        ...
        fn test_gitignore_accessibility() {
            ...
            assert!(content.contains("target/") || content.contains("/target"),
    ...
    mod end_to_end_integration_tests {
        ...
        fn test_project_runs_without_arguments() {
            ...
            let output = Command::new("./target/debug/iora")
                .output();
    ...
    mod dependency_integration_tests {
        ...
        fn test_tokio_async_runtime() {
            ...
            assert!(true, "Tokio integration validated through successful compilation");
        }
