...
mod tests {
    ...
    mod byok_config_tests {
        ...
        fn test_api_key_format_validation() {
            ...
            let valid_coingecko_key = "CG-test123456789012345678901234567890";
            assert!(valid_coingecko_key.starts_with("CG-"), "CoinGecko keys should start with CG-");
            assert_eq!(valid_coingecko_key.len(), 34, "CoinGecko keys should be 34 characters");
